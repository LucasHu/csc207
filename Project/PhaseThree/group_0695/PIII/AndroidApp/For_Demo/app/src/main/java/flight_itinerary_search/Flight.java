...
public class Flight implements Serializable {
     ...
     *
     * @param seats
     *            is the number of seats the flight has.
     */
    ...
    public String returnFlightWithTimeCost() {
        ...
        returnedFlight = this.flightNumber + "," + this.departureDateTime + ","
                + this.arriveDateTime + "," + this.airline + "," + this.origin
                + "," + this.destination + "," + costTwoDecimal + "," + travelTime + "\n";
    ...
    /**
     * Tests if the flight is fully booked, return true if it is full, otherwise
     * return false.
     *
     * @return if the flight is fully booked.
     */
    ...
    public String toString() {
        return "Flight{" + "flightNumber='" + flightNumber + '\''
                ...
                + ", arriveDateTime='" + arriveDateTime + '\'' + ", airline='"
