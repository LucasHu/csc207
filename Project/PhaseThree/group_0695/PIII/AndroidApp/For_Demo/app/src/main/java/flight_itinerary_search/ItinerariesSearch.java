...
public class ItinerariesSearch {
    ...
    private List<Itinerary> bookableItinerariesList
     ...
     */
    public List<Itinerary> findAllItineraries(String departureDate,
                                              String origin, String destination, List<Flight> allFlightsList) {
    ...
    /**
     * Returns a list of itineraries, in which, all flights are not fully
     * booked.
     *
     * @param ItineraryList
     *            is a list of itineraries.
     * @return a list of itineraries, in which all flights are not fully booked.
     */
