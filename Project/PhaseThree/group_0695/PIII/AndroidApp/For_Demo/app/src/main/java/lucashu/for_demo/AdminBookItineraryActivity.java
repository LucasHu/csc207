...
public class AdminBookItineraryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_book_itinerary);
    ...
    public void bookItinerary(View view) {
        ...
        String currentClient = usernameField.getText().toString();
