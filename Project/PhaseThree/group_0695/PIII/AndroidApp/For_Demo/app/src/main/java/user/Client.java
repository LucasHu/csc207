...
public class Client extends User implements Serializable{
    ...
    /**
     * Book an itinerary for the client.
     *
     * @param Itinerary
     *            is the itinerary that the client will book.
     */
    public void bookItinerary(Itinerary Itinerary) {
        ...
        if (this.bookedItineraries == null) {
    ...
    /**
     * Returns all booked Itinerary of the client into a string
     *
     * @return all booked Itinerary of the client into a string
     */
